...
- [ ] 15-01-PLAN.md — Socle neutre : prédicat d'identité marqueur+nom d'exe, analyse tolérante « ne rien écrire », sérialisation fidèle, fixture de l'état réel pollué (vague 1)
...
|-------|----------------|--------|-----------|
| 15. Idempotence des intégrations | 0/3 | Planned | - |
