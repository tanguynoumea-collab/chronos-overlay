...
- [x] 09-02-PLAN.md — Calibration manuelle : dialogue plafonds + CalibrateBudgetsCommand (GAP-1) + RequestRefresh + câblage DI du calibrateur (CAL-01/CAL-02)
- [x] 09-03-PLAN.md — Surfaçage des tokens estimés : WindowGaugeViewModel.TokensText + TextBlocks discrets (NET-02)
**UI hint**: yes
